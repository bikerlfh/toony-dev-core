...
const STORAGE_KEY = "toony_sidebar_collapsed";
...
export function Sidebar() {
  ...
  return (
    <aside
      className={`flex flex-col border-r border-slate-800/60 bg-slate-950 transition-[width] duration-200 ${
    ...
    >
      ...
      <div className="border-b border-slate-800/60 p-4">
        <div className={`flex items-center ${collapsed ? "justify-center" : "gap-2.5"}`}>
          <div className="h-7 w-7 shrink-0 rounded-lg bg-indigo-500/15 flex items-center justify-center">
          ...
          {!collapsed && (
            <button
              ...
              className="ml-auto flex h-6 w-6 items-center justify-center rounded-md text-slate-600 transition-colors hover:bg-slate-900 hover:text-slate-400"
      ...
      {collapsed && (
        <div className="px-2 pt-3">
          <button
            ...
            className="flex w-full items-center justify-center rounded-md py-1.5 text-slate-600 transition-colors hover:bg-slate-900 hover:text-slate-400"
      ...
      {collapsed && (
        <div className="px-2 pt-2">
          <button
            ...
            title="Search (⌘K)"
            className="flex w-full items-center justify-center rounded-md py-2 text-slate-500 transition-colors hover:bg-slate-900/60 hover:text-slate-400"
          >
      ...
      {/* Navigation */}
      <nav className={`flex-1 space-y-0.5 ${collapsed ? "px-2 py-4" : "p-4"}`}>
        {NAV_ITEMS.map((item) =>
