          ...
          >
            ...
            <div className="flex flex-1 flex-col gap-2 min-h-[4rem]">
              {columnIssues.length === 0 ? (
                <div
                  className={`flex flex-1 items-center justify-center rounded-lg border border-dashed py-8 transition-colors duration-150 ${
                    isOver
                ...
                >
                  <p className="text-xs">{isOver ? "Drop here" : "No issues"}</p>
                </div>
              ) : (
